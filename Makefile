...
# ce
LRCMDR_OBJS=src/main.o src/ImguiLibretro.o src/CoreInfo.o src/Memory.o src/libretro/BareCore.o src/libretro/Core.o src/dynlib/dynlib.o src/fnkdat/fnkdat.o src/speex/resample.o
